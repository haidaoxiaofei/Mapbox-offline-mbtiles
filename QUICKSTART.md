...
The quickest way is just to download the [AAR from our the GitHub repository](https://github.com/mapbox/mapbox-android-sdk/blob/master/MapboxAndroidSDK.aar). If you want to build from source to use experimental features and the latest fixes, read the [README](https://github.com/mapbox/mapbox-android-sdk/blob/master/README.md) file in the repo. Once you've got the AAR, add it to the build / class path of your IDE.
