...
public class MinimapOverlay extends TilesOverlay {
     ...
     * @param tileRequestCompleteHandler a handler for the tile request complete notifications
     ...
     *
     * @param pContext                   a context
     * @param tileRequestCompleteHandler a handler for tile request complete notifications
     */
    public MinimapOverlay(final Context pContext, final Handler pTileRequestCompleteHandler) {
